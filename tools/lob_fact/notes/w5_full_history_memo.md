...
**hard 类台账（截至 2026-09-11 14:10，7 例 / 6 个月，横跨 3 个标的）**：
`301308.SZ`@20250922(0.89963) / @20251030 / @20260807(0.89981) / @20260507(**0.89367**)
/ @20260511(0.89799)；`300418.SZ`@20260113(0.89616)；`301611.SZ`@20260629(0.89004)
—— 全部 `m1a_presence`、全部紧贴 0.90 日级地板（0.8900–0.8998 窄带，**无一崩塌**）、
**高度集中于 301308.SZ（5/7）但非单一标的**（后两例换码，见 §3b 分布表）→ 支持 §3b
归类为"极高消息速率标的的 δ 滞后尾部（方法边界）"；累积率 7/~63K ≈ 0.011% ≪ 0.1%。
