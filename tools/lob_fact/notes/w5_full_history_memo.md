...
**hard 类台账（截至 2026-09-11 04:13，4 例 / 4 个月）**：`301308.SZ@20250922`(0.89963)
/ `301308.SZ@20251030` / `300418.SZ@20260113`（**0.89616**）/ `301308.SZ@20260807`
(0.89981) —— 全部 `m1a_presence`、全部紧贴 0.90 日级地板、**非同一标的**（第 3 例换码）
→ 支持 §3b 归类为"当日某只极高消息速率标的的 δ 滞后尾部（方法边界）"，而非绑定单一
instrument 的引擎缺陷；累积率 4/~45K ≈ 0.009% ≪ 0.1%。
