...
├── research/              研究：因子库（factor/）、剩余工具（tools/：strategies、factor_lib）、研究档案（docs/）
...
| 我想… | 去哪 |
|---|---|
| 写一个因子并跑出结果 | [research/docs/factor-authoring-manual.md](research/docs/factor-authoring-manual.md)（单页闭环：写→自检→跑→读数→入库） |
...
> 完整闭环（含入库/提交/常见坑）：[research/docs/factor-authoring-manual.md](research/docs/factor-authoring-manual.md)
