...
| `workspace/` | 工作区约定与台账：`directory-conventions.md`（结构唯一权威）、`data-map.md`（数据唯一权威）、`pending-items.md`、`issue-register.md`（GitHub issue 当前待办与历史处理索引）、`archive-policy.md`、`traceability-matrix.md` 等 | 根 `docs/` |
