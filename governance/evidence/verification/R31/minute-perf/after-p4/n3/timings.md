...
```
date=2026-09-19T00:11:26+08:00
commit=6f7dbdc666a992587c5d77988f4d95e9e32ccdec
dirty_files=41
window=2024-01-02..2024-03-29
chunk_days=10 timeout_s=1500 chunk_workers=3
...
|---|---|---|---|---|---|---|---|---|---|
| am_pm_vol | ERROR(rc=1) FACTORLAB_MAX_MEMORY；看门狗仍会按 chunk 边界协作检查。 | —（未完成） | — | — | — | — | — | — | 621MB |
| autocorr_micro | ERROR(rc=1) FACTORLAB_MAX_MEMORY；看门狗仍会按 chunk 边界协作检查。 | —（未完成） | — | — | — | — | — | — | 627MB |
| vol_asym | ERROR(rc=1) FACTORLAB_MAX_MEMORY；看门狗仍会按 chunk 边界协作检查。 | —（未完成） | — | — | — | — | — | — | 625MB |
| vol_price_corr | ERROR(rc=1) FACTORLAB_MAX_MEMORY；看门狗仍会按 chunk 边界协作检查。 | —（未完成） | — | — | — | — | — | — | 627MB |
