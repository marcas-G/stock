...
Run `bash governance/evidence/verification/R48/pr42-xscore-hardening/verify.sh` from the stock repository root to reproduce the relevant checks. `verify.log` contains the command trace and raw output.
