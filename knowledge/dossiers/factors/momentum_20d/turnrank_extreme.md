...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`momentum_20d_turnrank_top10`/`_top5`/`_top2` | 挖矿轮13：阈值扫描 0.8→0.9/0.95/0.98，见 [`turnrank_top10.md`](turnrank_top10.md) | -0.0448~-0.0471 | -6.46~-12.58 | **观察中（需期外验证）**——mean 持平 t 机械膨胀 |
