...
> 数据快照自 `runs/platform/max_effect_20d/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生三变体：`_high` / `_extcnt` / `_zmax` | 挖因子轮 1（H1 盘中摸高 / H3 极端日次数 / H2 波动率标准化；CH 无 ST 版） | 0.0699 / 0.0532 / 0.0301 | 5.00 / 5.89 / 5.01 | H1、H3 候选（见各自档案）；H2 证伪（近 26 周失效） |
