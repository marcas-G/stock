...
> 数据快照自 `runs/platform/vol_run_energy_symrun_r30/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生两变体：`_flip` / `_streak` | 挖因子轮 2（H1 方向翻转频率 / H2 真游程长度；CH 无 ST 版） | 0.0193 / 0.0163 | 6.81 / 5.45 | 负结论：均弱于种子（0.0268/8.61）——alpha 来自 energy/bell，"游程项近常数"非缺陷 |
