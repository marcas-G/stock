...
> 数据快照自 `runs/platform/turnover_accel/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`turnover_accel_inflow` | 挖矿轮10：对称→非对称（仅保留涌入），见 [`accel_inflow.md`](accel_inflow.md) | 0.0422 | 6.95 | **候选（升级）**：t/IR +31% |
