...
> 数据快照自 `runs/platform/turnover_level/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`turnover_level_ma20` | 挖矿轮4：瞬时→MA20 平滑，见 [`level_ma20.md`](level_ma20.md) | 0.0601 | 3.84 | **无效**（-17%/-50%，反证瞬时有效）|
