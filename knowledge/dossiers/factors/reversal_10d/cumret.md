...
> 数据快照自 `runs/platform/reversal_10d_cumret/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_10d_cumret_log` | 挖矿轮2：算术和→对数累积，见 [`cumret_log.md`](cumret_log.md) | 0.0371 | 3.05 | 观察中（-5%，假设不成立） |
