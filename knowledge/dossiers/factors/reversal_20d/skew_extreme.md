...
> 数据快照自 `runs/platform/reversal_20d_skew_extreme/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_20d_skew_extreme_w10` | 挖矿轮16：偏度窗口 20→10，见 [`skew_extreme_w10.md`](skew_extreme_w10.md) | -0.0204 | -4.43 | **无效**（-40% t）——lottery 是 20 日结构性非短期 |
