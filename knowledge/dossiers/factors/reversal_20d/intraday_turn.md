...
> 数据快照自 `runs/platform/reversal_20d_intraday_turn/summary.json`（2026-08-18）。
...
| 日期 | 变体/版本 | 改动 | IC mean | t | 结论 |
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_20d_intraday_turn_high` | 挖矿轮11：close/open→high/open（冲高幅度），见 [`intraday_turn_high.md`](intraday_turn_high.md) | 0.0781 | 4.94 | **观察中（混合）**（+32% 但波动 +37%、近期 t 恶化） |
