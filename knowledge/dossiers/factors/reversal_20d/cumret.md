...
> 数据快照自 `runs/platform/reversal_20d_cumret/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_20d_cumret_freq` | 挖矿轮6：幅度→频率（sign 计数），见 [`cumret_freq.md`](cumret_freq.md) | 0.0162 | 1.91 | **无效**（-76%，反证幅度驱动） |
