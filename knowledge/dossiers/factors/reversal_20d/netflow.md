...
> 数据快照自 `runs/platform/reversal_20d_netflow/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_20d_netflow_vol` | 挖矿轮9：amount→volume（去价格水平），见 [`netflow_vol.md`](netflow_vol.md) | 0.0327 | 4.21 | **观察中（边际）**：ρ=0.919 近等效 |
