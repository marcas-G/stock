...
> 数据快照自 `runs/platform/reversal_20d_intraday/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`reversal_20d_overnight` | 挖矿轮5：日内→隔夜分解，见 [`overnight.md`](overnight.md) | +0.024 (raw) | +4.35 | **无效**（假设反转）——发现**隔夜动量**（近 26 周 t=+2.51） |
