...
> 数据快照自 `runs/platform/rsi_reversal_14/summary.json`（2026-08-18）。
...
|------|-----------|------|---------|---|------|
| 2026-09-16 | 衍生：`rsi_reversal_14_ret` | 挖矿轮1：`ts_delta`→`returns`（尺度不变性），见 [`reversal_14_ret.md`](reversal_14_ret.md) | 0.0389 | 3.74 | 观察中（比值尺度不变，主假设证伪） |
